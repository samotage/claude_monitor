...
### NFR: Visual Consistency

The logging panel SHALL use the same visual design language as existing tabs (dark theme, monospace fonts, consistent spacing).

### NFR: Animation Performance

Expand/collapse animations SHALL complete within 200ms.

### NFR: Search Performance

Search filtering SHALL complete within 100ms for typical log volumes.

### NFR: Polling Interval

Auto-refresh polling SHALL occur at a reasonable interval that balances responsiveness with resource usage.
