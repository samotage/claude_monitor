...
Enable Claude Monitor to parse Claude Code JSONL session logs, detect session completion, and automatically summarise session activity into project YAML files without AI dependency.
